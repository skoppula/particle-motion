class Mutator{
  ...
  int newPhysObject(){
    ...
    String velR =  JOptionPane.showInputDialog(null, "Enter velocity and radius. Example: 20 5", "Create New Particle: Velocity and Diameter", 1);
  ...
  void changeDamp(){
    try{
      ...
      "For sanity sake, choose number >0.8 and <=1", "Dampening", 1));
      if(a<=0.8||a>1)
        throw new Exception();
      damp = a;
    }
